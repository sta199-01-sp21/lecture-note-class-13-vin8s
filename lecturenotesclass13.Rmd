...
```{r practice_2_ci}
ci_mice_died <- get_ci(boot_prop_2, level = .90)
ci_mice_died
```
...
Somewhere between 55.2% - 65.1% of mice that were on the treatment lived. This doesn't seem to be a high proportion of mice that lived from the number of them that received the treatment. The treatment could be improved.
